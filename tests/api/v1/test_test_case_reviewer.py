...
async def test_tc_review_happy_path(client):
    """POST /api/v1/test-case-review with valid baseline_id returns 200 HTML viewer."""
    response = await client.post("/api/v1/test-case-review", json={"baseline_id": "BASE-84429"})
