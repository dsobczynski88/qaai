...
class PromptConfig(BaseModel):
    ...
    hazard_h1: str = "hazard_h1/v7.0.0/template.jinja2"
    hazard_h2: str = "hazard_h2/v3.0.0/template.jinja2"
    hazard_h3: str = "hazard_h3/v6.0.0/template.jinja2"
    hazard_h4: str = "hazard_h4/v3.0.0/template.jinja2"
    hazard_h5: str = "hazard_h5/v3.0.0/template.jinja2"
    hazard_h6: str = "hazard_h6/v3.0.0/template.jinja2"
    hazard_r7: str = "hazard_r7/v2.0.0/template.jinja2"
